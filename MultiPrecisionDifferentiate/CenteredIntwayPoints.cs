...
namespace MultiPrecisionDifferentiate {
    public static class CenteredIntwayPoints<N> where N : struct, IConstant {
        ...
        static CenteredIntwayPoints() {
            using MemoryStream stream = new();
            using (MemoryStream resorce = new(Resource.centered_intway_acc64)) {
