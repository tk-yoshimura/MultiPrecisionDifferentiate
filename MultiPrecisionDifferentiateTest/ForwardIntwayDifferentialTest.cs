    ...
    public class ForwardIntwayDifferentialTest {
        ...
        public void DifferentiateExpTest() {
            for (int derivative = 0; derivative <= 64; derivative++) {
                MultiPrecision<Pow2.N8> y = ForwardIntwayDifferential<Pow2.N8>.Differentiate(
        ...
        public void DifferentiateExpArrayTest() {
            foreach ((int derivative, MultiPrecision<Pow2.N8> y) in ForwardIntwayDifferential<Pow2.N8>.Differentiate(
